...
Prints a .pyc bytecode file into human-readable form

Based on https://towardsdatascience.com/understanding-python-bytecode-e7edaae8734d#:~:text=When%20we%20execute%20a%20source,by%20the%20target%20machine%20directly.
...
if sys.version_info >= (3, 7):
    header_size = 16
version_string = ''.join([str(v) for v in sys.version_info[:2]])
pyc_filename = os.path.join(
    '.', '__pycache__', fr"{sys.argv[1]}.cpython-{version_string}.pyc")
with open(pyc_filename, "rb") as f:
